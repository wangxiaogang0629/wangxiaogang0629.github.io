...
class IconSvg extends Component {
  ...
  componentDidMount() {
    ...
    //把svg标签中的内容置空，防止鼠标浮动到icon,就出现titel提示说明
    let _objName = document.getElementById('svgIconId').getElementsByTagName('title');
    for (var i = 0; i < _objName.length; i++) {
      _objName[i].innerHTML = '';
    }
  }
